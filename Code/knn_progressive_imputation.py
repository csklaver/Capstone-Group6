...
def impute_progressive_knn(df, nan_df):
    ...
    for i in range(9,len(nan_df)+1):
        ...
        df_start = df_copy[nan_df.iloc[3:i, ].index]
...
df_progressive_knn.to_csv('/Users/carolinesklaver/Desktop/Capstone/NHANES/data/csv_data/df_progressive_knn_2.csv', index=False)