...
df_mean_75 = missing_values(df_raw, 0.75,0.75, 'mean')
# df_median_50 = missing_values(df_raw, 0.50,0.50, 'median')
...
df_raw_train, df_raw_test = train_test_split(df_mean_75, test_size=0.2, random_state=SEED)
...
# Make directory
directory = os.path.dirname('cv_results/mean_75_10/')
...
for acronym in pipes.keys():
    ...
    print(pipes[acronym], confusion_matrix(y_test, y_pred))
    ...
    cv_results.to_csv(path_or_buf='cv_results/mean_75_10/' + acronym + '.csv', index=False)
